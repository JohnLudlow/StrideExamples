...
public class UIManager
{
    ...
    private readonly Stride.UI.Panels.Grid _grid;
    ...
    public UIManager(SpriteFont spriteFont, List<IClickable> clickables)
    {
        _font = spriteFont;
        _grid = CreateGrid();
    ...
    private Stride.UI.Panels.Grid CreateGrid() => new()
    {
