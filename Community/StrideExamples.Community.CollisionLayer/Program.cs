...
void Start(Scene scene)
{
    ...
    // Create enemy entity
    CreateEntityWithLayer("Enemy", Color.Red, new Vector3(-.5f, 20, 1f), scene, enemyLayer);
    // doesn't collide with enemy layer
    // CreateEntityWithLayer("Enemy2", Color.Orange, new Vector3(-0.1f, 12, 0.5f), scene, enemyLayer);
}
